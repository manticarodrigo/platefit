	...
	<section class="py-6 px-5 px-3-md bg-color-light row center">
		...
		?>
			<article class="col-4 col-3-lg col-2-md col-1-sm p-3 trainers__box">
				<a class="trainers__img" aria-label="Go to trainer profile" href="<?php echo get_post_permalink(); ?>" style="background-image: url(<?php the_field('image', $post_ID) ?>);"></a>
				<p class="mb-2 trainers__name letter-spacing-sm"><?php echo $full_name ?></p>
				<a class="link dark underline" aria-label="Go to trainer social media profile" target="_blank" href="<?php the_field('social_url', $post_ID) ?>">
